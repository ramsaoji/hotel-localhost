...
<head>
    ...
    <title>Online Booking Ramkrishna</title>
    <!-- Bootstrap Styles-->
       ...
       <div class="row">
                    <div class="col-md-12">
                        <h1 class="page-header">
                           NEW BOOKING <small>online</small>
                        </h1>
                    </div>
                </div> 
            ...
            if(!isset($_GET["rid"]))
            {
               header("location:index.php");
                ...
                $sql ="Select * from online where id = '$oid'";
                ...
                while($row=mysqli_fetch_array($re))
                {
                  ...
                  $ozip = $row['Zip'];
                  $oPhone = $row['Phone'];
                  $oNopeople = $row['Nopeople'];
                  $oExtperson = $row['Noperson'];
            ...
            ?>        
                              <!--    <div class="form-group">
                                            ...
                                            <label>Search from Mob</label>
                                            <div class="mob">
                                            <input  id="searchmob" name="Mob" class="form-control">
                                            <button id="mob-btn" type="submit" name="fetch-btn" class="btn btn-primary">Search</button>
                                            </div>
                              ...
                              if(isset($_POST['fetch-btn']))
                              {
                                ...
                                $mobid=$_POST['Mob'];
                                $query = "SELECT * FROM `copy` WHERE Phone='$mobid'";
                                  ...
                                  while($row = mysqli_fetch_array($query_run))
                                  {
                                    ...
                                    ?>
                                     ...
                                     <div class="form-group">
                                            ...
                                            <input name="fname" value="<?php echo $row['FName']; ?>" class="form-control" required>
                                            </div>
                                    <?php
                                  }
                      ...
                      <label>Title*</label>
                      <select name="title" class="form-control" required >
                          <option value="<?php  echo $otitle;?>" ><?php  echo $otitle;?></option>
                      ...
                      <div class="form-group">
                      <label>First Name*</label>
                      <input name="fname" class="form-control" value="<?php  echo $ofname;?>" required>
                      </div>

                      <div class="form-group">
                      <label>Last Name*</label>
                      <input name="lname" class="form-control" value="<?php  echo $olname;?>" required>
                      
              </div>
                <div class="form-group">
                      <label>Email*</label>
                      <input name="email" class="form-control" value="<?php  echo $oemail;?>" required>
                      
               </div>
                              <div class="form-group">
                      <label>Phone Number*</label>
                      <input name="phone" type ="text" maxlength="10" class="form-control" value="<?php  echo $oPhone;?>" required>
                    ...
                    <div class="panel panel-primary">
                        ...
                        <div class="panel-body">
                               ...
                               <div class="form-group">
                                            ...
                                            <input name="nopeople" type="text" maxlength="1" class="form-control" 
                                            value="<?php  echo $oNopeople;?>" required>
                                            
                               </div> 

                               <div class="form-group">
                                            <label>Extra Persons Name*</label>
                                            <input name="extperson" type="text" maxlength="50" class="form-control" placeholder="If No - Enter None/Enter Full Name" value="<?php  echo $oExtperson;?>" required>
                                            
                               </div>  
                              <div class="form-group">
                                            <label>State*</label>
                                            <input name="state" type="text" maxlength="20" class="form-control" value="<?php  echo $ostate;?>" required>
                                            
                               </div>
                               <div class="form-group">
                                            <label>City*</label>
                                            <input name="city" type="text" maxlength="20" class="form-control" value="<?php  echo $ocity;?>" required>
                                            
                               </div>
                               <div class="form-group">
                                            <label>Zip</label>
                                            <input name="zip" type="text" maxlength="6" class="form-control" value="<?php  echo $ozip;?>">
            ...
            <table class="row">
                ...
                <div class="form-group">
                                            ...
                                            <label>Select - <?php  echo $otroom;?></label>
                        ...
                        <option value="Single Room">SINGLE ROOM</option> -->
                            ...
                            <div class="form-group">
                                            <label>Select - <?php  echo $obed;?></label>
               ...
               <!--  <div class="form-group">
                ...
                <div class="form-group">
                                            ...
                                            <input name="cin" type ="date" class="form-control" value="<?php  echo $ocin;?>" required>
                                            
                               </div>
                 <div class="form-group">
                                            <label>Check-Out*</label>
                                            <input name="cout" type ="date" class="form-control" value="<?php  echo $ocout;?>" required>
            ...
            <?php
              if(isset($_POST['submit']))
              {
                  ...
                  else
                  {
                    ...
                    $newUser1="INSERT INTO `copy`(`Title`, `FName`, `LName`, `Email`, `Aadhar`,`State`,`City`,`Zip`,`Phone`,
                    `Nopeople`,`Noperson`, `Vehicle No`,`Arrival`,`Going`, `TRoom`, `Bed`,`RoomNo`, `Advance`, `cin`, `cout`,`stat`,`nodays`) VALUES ('$_POST[title]','$_POST[fname]','$_POST[lname]','$_POST[email]','$_POST[aadhar]','$_POST[state]','$_POST[city]','$_POST[zip]','$_POST[phone]','$_POST[nopeople]',
                       '$_POST[extperson]','$_POST[vehicle]','$_POST[arrival]','$_POST[going]','$_POST[troom]','$_POST[bed]','$_POST[roomno]','$_POST[advance]','$_POST[cin]','$_POST[cout]','$new',datediff('$_POST[cout]','$_POST[cin]'))";

                    mysqli_query($con,$newUser1);

                    $delonlineapp = "DELETE FROM `online` WHERE id = '$oid'";
                    mysqli_query($con,$delonlineapp);
