...
<div class="banner-top">
			...
			<div class="contact-bnr-w3-agile">
				<ul>
					<li><i class="fa fa-envelope" aria-hidden="true"></i><a href="mailto:info@example.com">INFO@RAMKRISHNA.COM</a></li>
		...
		<div class="container">
			<nav class="navbar navbar-default">
				<div class="navbar-header navbar-left">
					...
					<h1><a class="navbar-brand" href="index.php">RAMKRISHNA <span>LODGE</span><p class="logo_w3l_agile_caption">D.P Road, Chikhli</p></a></h1>
				</div>
							...
							<!-- Modal content-->
								<div class="modal-content">
									<div class="modal-header">
										...
										<h4>RAMKRISHNA <span>LODGE</span></h4>
...
<div class="col-md-12 book-form-left-w3layouts">
	<a href="admin/onlinebooking.php"><h2>BOOK A ROOM</h2></a>
</div>
		<div class="clearfix"> </div>
</div>
<!-- banner-bottom -->
...
<!--<div class="about-wthree" id="about">
		  <div class="container">
				   <div class="ab-w3l-spa">
                            <h3 class="title-w3-agileits title-black-wthree">About Our RAMKRISHNA LODGE</h3> 
	...
	<div class="container">
		<div class="advantages-main">
		   ...
		   <div class="advantage-bottom">
			 <div class="col-lg-12 advantage-grid left-w3ls wow bounceInLeft" data-wow-delay="0.3s">
					...
					<div class="price-block agile">
						...
						<div class="price-gd-bottom">
							...
							<div class="price-selet">	
								<h3><span>₹</span>800</h3>						
								<a href="admin/onlinebooking.php" >Book Now</a>
							</div>
						</div>
					</div>
				</div>
	...
	<div class="container">
		<div class="col-lg-6 col-md-6 col-sm-6 contact-w3-agile2" data-aos="flip-left">
			<div class="contact-agileits">
				<h4>Contact Us</h4>
				<p class="contact-agile2">Get a call from us</p>
				...
				if(isset($_POST['sub']))
				{
					...
					echo '<script type="text/javascript">
                              ...
                              text: "You will get call from us shortly.",
                              icon: "success",
                              button: "Ok",
                            });
                            </script>';
		...
		<div class="col-lg-6 col-md-6 col-sm-6 contact-w3-agile1" data-aos="flip-right">
			...
			<p class="contact-agile1"><strong>Phone :</strong>+91 9876543210</p>
			<p class="contact-agile1"><strong>Email :</strong> <a href="mailto:info@example.com">INFO@RAMKRISHNA.COM</a></p>
			<p class="contact-agile1"><strong>Address :</strong> D.P Road, Chikhli</p>
...
<!-- /contact -->
			<div class="copy">
		        <p>© 2001 RAMKRISHNA . All Rights Reserved | Design by <a href="index.php">RAMKRISHNA</a> </p>
		    </div>
<!--/footer -->
<!-- js -->
